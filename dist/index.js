...
var require_parser = __commonJS({
  "src/parser.js"(exports2, module2) {
    ...
    function parseCoverage2(filePath) {
      ...
      for (const line of lines) {
        ...
        const packageName = path2.dirname(filePathString);
...
var require_pusher = __commonJS({
  "src/pusher.js"(exports2, module2) {
    var axios = require_axios();
    function formatLabels(labels) {
      return Object.entries(labels).map(([key, value]) => `${key}="${value}"`).join(",");
    }
    module2.exports = async function pushMetrics2(prometheusEndpoint, jobName, coverageData, labels) {
...
var { parseCoverage } = require_parser();
var pushMetrics = require_pusher();
async function run() {
